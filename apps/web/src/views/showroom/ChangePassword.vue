<template>
  <FullScreenLayout>
    <div class="flex min-h-screen items-center justify-center bg-gray-50 p-4 dark:bg-gray-900">
      <div class="w-full max-w-md rounded-2xl bg-white p-8 shadow-theme-md dark:bg-gray-800">
        <h1 class="mb-2 text-xl font-semibold text-gray-800 dark:text-white">Cambiar contraseña</h1>
        ...
        <form class="space-y-4" @submit.prevent="submit">
          <div>
            ...
            <div class="relative">
              <input
                ...
                required
                class="w-full rounded-lg border border-gray-300 py-2.5 pl-4 pr-11 text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
              />
              <button
                type="button"
                class="absolute right-3 top-1/2 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400"
          ...
          <div>
            <label class="mb-1 block text-sm text-gray-600 dark:text-gray-300">Confirmar nueva</label>
            <div class="relative">
              <input
          ...
          <button
            type="submit"
            class="w-full rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 disabled:opacity-60"
            :disabled="loading"
          >
