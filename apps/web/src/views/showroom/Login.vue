  ...
  <FullScreenLayout>
    <div class="flex min-h-screen items-center justify-center bg-gray-50 p-6 dark:bg-gray-900">
      <div class="w-full max-w-md">
        <router-link
          to="/"
          class="mb-4 inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
        >
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div class="mb-8 text-center">
            ...
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">PuntoManeki</h1>
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  required
                  class="w-full rounded-lg border border-gray-300 py-2.5 pl-4 pr-11 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
...
async function handleSubmit() {
  ...
  if (ok) {
    router.push(auth.mustChangePassword ? '/change-password' : auth.isSuperAdmin ? '/platform' : '/home')
  }
}
</script>
